    ...
    for (let ele of document.getElementsByClassName("settingsFileSelButton")) {
        ele.onclick = async e => {
            ...
            const directoryDialog =
                ele.hasAttribute("dialogDirectory") && ele.getAttribute("dialogDirectory") == "true"
...
const settingsAboutChangelogTitle =
    settingsTabAbout.getElementsByClassName("settingsChangelogTitle")[0]
const settingsAboutChangelogText =
    settingsTabAbout.getElementsByClassName("settingsChangelogText")[0]
const settingsAboutChangelogButton =
    settingsTabAbout.getElementsByClassName("settingsChangelogButton")[0]
...
function populateReleaseNotes() {
    $.ajax({
        url: "https://github.com/dscalzi/AdventureLifeLauncher/releases.atom",
        success: data => {
...
const settingsUpdateChangelogTitle =
    settingsTabUpdate.getElementsByClassName("settingsChangelogTitle")[0]
const settingsUpdateChangelogText =
    settingsTabUpdate.getElementsByClassName("settingsChangelogText")[0]
